...
author_1 = Author.create(user_id: user_2.id)
...
test_1 = Test.create(title: 'Ruby Language', category_id: categories[0].id,
                     author_id: author_1.id, level: 2)
test_2 = Test.create(title: 'JavaScript', category_id: categories[0].id,
                     author_id: author_1.id, level: 1)
test_3 = Test.create(title: 'HTML/CSS', category_id: categories[0].id, author_id: author_1.id)
test_4 = Test.create(title: 'Elementary', category_id: categories[1].id, author_id: author_1.id)
test_5 = Test.create(title: 'Artists', category_id: categories[2].id, author_id: author_1.id)
